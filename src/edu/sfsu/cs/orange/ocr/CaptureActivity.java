...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  /** The default server address to use. */
  public static final String DEFAULT_SERVER_ADDRESS = "http://192.168.1.100:8000";
...
//    initTCPClient("192.168.1.100", "9999");
  }
  ...
  public void onShutterButtonClick(ShutterButton b) {
    if (isContinuousModeActive) {
    	if(lastResult != null) {
    		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
    	    String addr = prefs.getString(PreferencesActivity.KEY_SERVER_ADDRESS, CaptureActivity.DEFAULT_SERVER_ADDRESS);
    		new SendResultAsyncTask(this).execute(addr, lastResult.getText());
    	}
//    	onShutterButtonPressContinuous();
    } else {
      if (handler != null) {
  ...
  private void requestDelayedAutoFocus() {
    ...
    cameraManager.requestAutoFocus(700L);
  }
  ...
  private void retrievePreferences() {
      ...
      serverAddress = prefs.getString(PreferencesActivity.KEY_SERVER_ADDRESS, CaptureActivity.DEFAULT_SERVER_ADDRESS);
  ...
  private void setDefaultPreferences() {
    ...
    // Translation
    prefs.edit().putString(PreferencesActivity.KEY_SERVER_ADDRESS, CaptureActivity.DEFAULT_SERVER_ADDRESS).commit();
