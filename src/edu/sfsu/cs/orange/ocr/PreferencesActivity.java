...
public class PreferencesActivity extends PreferenceActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    editTextPreferenceServerAddress = (EditTextPreference) getPreferenceScreen().findPreference(KEY_SERVER_ADDRESS);
  }
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
    ...
    if (key.equals(KEY_SERVER_ADDRESS)) {
    	editTextPreferenceServerAddress.setSummary(sharedPreferences.getString(key, CaptureActivity.DEFAULT_SERVER_ADDRESS));
  ...
  protected void onResume() {
    ...
    editTextPreferenceServerAddress.setSummary(sharedPreferences.getString(KEY_SERVER_ADDRESS, CaptureActivity.DEFAULT_SERVER_ADDRESS));
